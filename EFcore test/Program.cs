...
namespace EFcore_test
{
    class Program
    {
        ...
        {
            Console.WriteLine("=== System Zarządzania Studentami ===\n");
        ...
        static async Task ShowMenu(ApplicationDbContext context)
        {
            while (true)
            {
                ...
                Console.WriteLine("5. Wypisz studentów kursu");
                Console.WriteLine("6. Wypisz dane studenta z kursami");
                Console.WriteLine("7. Wypisz studentów danego roku");
                Console.WriteLine("8. Pokaż wszystkich studentów");
        ...
        // 1. Dodaj studenta (+ automatycznie profil)
