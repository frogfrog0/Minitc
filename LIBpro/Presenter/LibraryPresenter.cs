...
namespace LibraryApp.Presenter
{
    public class LibraryPresenter
    {
        ...
        public LibraryPresenter(BookForm view, BookRepository repository)
        {
            ...
            view.uzytkownikpanel += uzytkownikpanel;
        ...
        private void uzytkownikpanel()
        {
            view.tablica.Hide();
            view.paneluzytkownika.Show();
            Uzytkownikmodel uzytkownikmodel = new Uzytkownikmodel();
            Presenteruzytkownik presenteruzytkownik = new Presenteruzytkownik((Paneluzytkownika)view.paneluzytkownika, uzytkownikmodel, view);
        }
        private void adminpanel()
        {
            view.tablica.Hide();
            view.PanelAdmina.Show();
            Adminmodel adminmodel = new Adminmodel();
            Presenteradmin presenteradmin = new Presenteradmin((Adminpanelksiazki)view.PanelAdmina, adminmodel, (Adminpaneluzytkownicy)view.Paneladminauzytkownicy, (Adminpanelogloszenia)view.Paneladminaogloszenia, view);
        }
    }
}
