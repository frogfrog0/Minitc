...
namespace projekt_2_na_punkty.Presenter
{
    internal class presenter
    {
        ...
        public presenter(Form1 view, Model.Totalcommander model)
        {
            _view = view;
            _model = model;
            _view.placeholder = _model.Dyski();
            _view.placeholderv2 = _model.Dyski();
        ...
        {
            _view.path = _model.acpath();
        }
        private void updatetree() {
            
            _view.tree = _model.treecontent();
        }
        ...
        {
            _view.pathv2 = _model.acpath2();
        }
        private void updatetree2()
        {

            _view.treev2 = _model.treecontent2();
        }
